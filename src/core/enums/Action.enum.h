...
enum class Action : size_t {
    ...
    ROTATION_SNAPPING,
    GRID_SNAPPING,
    VERTEXNOTE_GEOMETRY_SNAPPING,
    VERTEXNOTE_GRID_SNAPPING,
    VERTEXNOTE_CONSTRAINT_COINCIDENT,
    VERTEXNOTE_CONSTRAINT_HORIZONTAL,
    VERTEXNOTE_CONSTRAINT_VERTICAL,
    VERTEXNOTE_CONSTRAINT_FIXED_LENGTH,
    VERTEXNOTE_CONSTRAINT_EDIT_FIXED_LENGTH,
    VERTEXNOTE_CONSTRAINT_RADIUS,
    VERTEXNOTE_CONSTRAINT_PARALLEL,
    VERTEXNOTE_CONSTRAINT_PERPENDICULAR,
    VERTEXNOTE_CONSTRAINT_DELETE,
    PREFERENCES,
    ...
    TOOL_DRAW_LINE,
    TOOL_DRAW_SPLINE,
    TOOL_DRAW_VERTEX_LINE,
    TOOL_DRAW_VERTEX_POLYLINE,
    TOOL_DRAW_VERTEX_RECTANGLE,
    TOOL_DRAW_VERTEX_CIRCLE,
    TOOL_DRAW_VERTEX_ARC,
    TOOL_DRAW_VERTEX_CONSTRUCTION_LINE,
    TOOL_DRAW_VERTEX_CONSTRUCTION_CIRCLE,
    SETSQUARE,
    COMPASS,
...
constexpr auto Action_fromString(const std::string_view value) -> Action {
    for (size_t n = 0; n < vn::to_underlying(Action::ENUMERATOR_COUNT); n++) {
