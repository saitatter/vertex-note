...
public:
    ...
    PageView* getViewFor(size_t pageNr) const;
    ...
    void endTextAllPages(PageView* except = nullptr) const;

    void endPendingInputAllPages() const;
    ...
    std::vector<std::unique_ptr<PageView>> const& getViewPages() const;
...
private:
    ...
    static auto clearMemoryTimer(VertexNoteView* widget) -> gboolean;
...
private:
    ...
    std::vector<std::unique_ptr<PageView>> viewPages;
