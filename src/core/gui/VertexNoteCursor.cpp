...
VertexNoteCursor::VertexNoteCursor(Control* control): control(control) {
    // clang-format off
...
VertexNoteCursor::~VertexNoteCursor() = default;


void VertexNoteCursor::setInputDeviceClass(InputDeviceClass device) { this->inputDevice = device; }


// pen or hi-light cursor will be a DrawDir cursor instead
void VertexNoteCursor::activateDrawDirCursor(bool enable, bool shift, bool ctrl) {
...
void VertexNoteCursor::setMouseDown(bool mouseDown) {
...
void VertexNoteCursor::setMouseSelectionType(CursorSelectionType selectionType) {
...
void VertexNoteCursor::setRotationAngle(double angle) { this->angle = angle; }
void VertexNoteCursor::setMirror(bool mirror) { this->mirror = mirror; }

/*This handles setting the busy cursor for the main window and calls
 * updateCursor to set the busy cursor for the VertexNoteWidget region.
 */
void VertexNoteCursor::setCursorBusy(bool busy) {
...
void VertexNoteCursor::setInsidePage(bool insidePage) {
...
void VertexNoteCursor::setInvisible(bool invisible) {
...
void VertexNoteCursor::updateCursor() {
    MainWindow* win = control->getWindow();
    if (!win) {
        return;
    }
...
auto VertexNoteCursor::getResizeCursor(double deltaAngle) -> GdkCursor* {
    if (this->mirror) {
...
auto VertexNoteCursor::getEraserCursor() -> GdkCursor* {
...
auto VertexNoteCursor::getHighlighterCursor() -> GdkCursor* {
...
auto VertexNoteCursor::getPenCursor() -> GdkCursor* {
...
auto VertexNoteCursor::createHighlighterOrPenCursor(double alpha) -> GdkCursor* {
...
void VertexNoteCursor::setCursor(guint cursorID) {
...
auto VertexNoteCursor::createCustomDrawDirCursor(int size, bool shift, bool ctrl) -> GdkCursor* {
