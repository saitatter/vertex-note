...
vn::util::WidgetSPtr AbstractToolItem::createToolItem(bool horizontal) {
    vn::util::WidgetSPtr item = createItem(horizontal);
    ...
    return vn::util::WidgetSPtr(GTK_WIDGET(wrap), vn::util::adopt);
}
