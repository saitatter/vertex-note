...
const char* TOOLBAR_INI_HEADER =
        ...
        "VERTEXNOTE_GEOMETRY_SNAPPING,VERTEXNOTE_GRID_SNAPPING,CONSTRAINT_COINCIDENT,CONSTRAINT_HORIZONTAL,"
        "CONSTRAINT_VERTICAL,CONSTRAINT_FIXED_LENGTH,CONSTRAINT_EDIT_FIXED_LENGTH,CONSTRAINT_PARALLEL,"
        "CONSTRAINT_PERPENDICULAR,CONSTRAINT_DELETE\n"
        "\n"
        " View: "
