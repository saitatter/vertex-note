...
CairoPdfExport::CairoPdfExport(const Document* doc, ProgressListener* progressListener):
        doc(doc), progressListener(progressListener) {}

CairoPdfExport::~CairoPdfExport() {
 ...
 */
void CairoPdfExport::setExportBackground(ExportBackgroundType exportBackground) {
    this->exportBackground = exportBackground;
}

auto CairoPdfExport::startPdf(const fs::path& file, bool exportOutline) -> bool {
...
void CairoPdfExport::configureCairoFontOptions() {
...
void CairoPdfExport::exportPage(size_t page, bool exportPdfBackground) {
...
void CairoPdfExport::exportPageLayers(size_t page) {
    PageRef p = doc->getPage(page);
...
auto CairoPdfExport::createPdf(fs::path const& file, const PageRangeVector& range, bool progressiveMode) -> bool {
    if (range.empty()) {
...
auto CairoPdfExport::createPdf(fs::path const& file, bool progressiveMode) -> bool {
...
auto CairoPdfExport::getLastError() -> std::string { return lastError; }

void CairoPdfExport::setLayerRange(const char* rangeStr) {
    if (rangeStr) {
