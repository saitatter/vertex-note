...
#include "PdfExport.h"  // for PdfExport
#include "filesystem.h"    // for path

class Document;
class ProgressListener;

class CairoPdfExport: public PdfExport {
public:
    CairoPdfExport(const Document* doc, ProgressListener* progressListener);
    ~CairoPdfExport() override;
