...
void ActionDatabase::Populator::populate(ActionDatabase* db) {
    ...
    populateImpl(std::make_index_sequence<vn::to_underlying(Action::ENUMERATOR_COUNT)>(), db);
}
...
void ActionDatabase::resetEnableStatus() {
    resetEnableStatusImpl(std::make_index_sequence<vn::to_underlying(Action::ENUMERATOR_COUNT)>(), this, control);
}
