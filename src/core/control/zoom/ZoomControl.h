...
public:
     ...
     */
    void zoomOneStep(ZoomDirection direction, vn::util::Point<double> zoomCenter);
     ...
     * @param zoomCenter position of zoom focus
     */
    void zoomScroll(ZoomDirection direction, vn::util::Point<double> zoomCenter);
     ...
     */
    void startZoomSequence(vn::util::Point<double> zoomCenter);
     ...
     */
    void zoomSequenceChange(double zoom, bool relative, vn::util::Point<double> scrollVector);
...
private:
    ...
    vn::util::Point<double> zoomWidgetPos;

    /// Scroll position (top left corner of view) to scale
    vn::util::Point<double> scrollPosition;

    /// Size {x, y} of the pixels before the current page that
    /// do not scale.
    vn::util::Point<double> unscaledPixels;
