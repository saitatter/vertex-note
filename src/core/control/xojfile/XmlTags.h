...
// Names corresponding to the vn::xml_tags::Type enum. They must imperatively correspond to the order of the enum!
...
namespace xoj {
namespace xml_tags = vn::xml_tags;
}
