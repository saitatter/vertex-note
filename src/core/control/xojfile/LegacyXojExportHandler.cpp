#include "LegacyXojExportHandler.h"
...
LegacyXojExportHandler::LegacyXojExportHandler() = default;
 ...
 */
void LegacyXojExportHandler::visitStrokeExtended(XmlPointNode* stroke, const Stroke* s) {
...
void LegacyXojExportHandler::writeBackgroundName(XmlNode* background, ConstPageRef p) {
