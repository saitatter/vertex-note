...
namespace vn::view {
class ArcByCenterStartEndView;
class OverlayView;
class Repaintable;
}  // namespace vn::view

class ArcByCenterStartEndHandler final: public InputHandler {
public:
    ArcByCenterStartEndHandler(Control* control, const PageRef& page);
    ~ArcByCenterStartEndHandler() override;
    ...
    [[nodiscard]] auto hasStartPoint() const -> bool;
...
private:
    ...
    std::shared_ptr<vn::util::DispatchPool<vn::view::ArcByCenterStartEndView>> viewPool;
};
