...
namespace vn::view {
class CircleByCenterRadiusView;
class OverlayView;
class Repaintable;
}  // namespace vn::view

class CircleByCenterRadiusHandler final: public InputHandler {
public:
    CircleByCenterRadiusHandler(Control* control, const PageRef& page);
    ~CircleByCenterRadiusHandler() override;
    ...
    [[nodiscard]] auto getCenterPoint() const -> Point;
...
private:
    ...
    std::shared_ptr<vn::util::DispatchPool<vn::view::CircleByCenterRadiusView>> viewPool;
};
