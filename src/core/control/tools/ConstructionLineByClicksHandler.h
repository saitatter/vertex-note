...
namespace vn::view {
class ConstructionLineByClicksView;
class OverlayView;
class Repaintable;
}  // namespace vn::view

class ConstructionLineByClicksHandler final: public InputHandler {
public:
    ConstructionLineByClicksHandler(Control* control, const PageRef& page);
    ~ConstructionLineByClicksHandler() override;
...
private:
    ...
    std::shared_ptr<vn::util::DispatchPool<vn::view::ConstructionLineByClicksView>> viewPool;
};
