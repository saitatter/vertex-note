...
namespace vn::view {
class ConstructionCircleByCenterRadiusView;
class OverlayView;
class Repaintable;
}  // namespace vn::view

class ConstructionCircleByCenterRadiusHandler final: public InputHandler {
public:
    ConstructionCircleByCenterRadiusHandler(Control* control, const PageRef& page);
    ~ConstructionCircleByCenterRadiusHandler() override;
...
private:
    ...
    std::shared_ptr<vn::util::DispatchPool<vn::view::ConstructionCircleByCenterRadiusView>> viewPool;
};
