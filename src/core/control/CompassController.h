...
public:
     ...
     */
    vn::util::Point<double> posRelToSide(double x, double y) const;
     ...
     */
    vn::util::Point<double> getPointForAngle(double a) const;
     ...
     */
    vn::util::Point<double> getPointForRadius(double r) const;
