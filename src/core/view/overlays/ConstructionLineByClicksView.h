...
class ConstructionLineByClicksHandler;
class OverlayBase;
class Range;
...
class ConstructionLineByClicksView final: public ToolView,
                                          public vn::util::Listener<ConstructionLineByClicksView> {
public:
    ConstructionLineByClicksView(const ConstructionLineByClicksHandler* handler, Repaintable* parent);
    ~ConstructionLineByClicksView() noexcept override;
...
private:
    const ConstructionLineByClicksHandler* handler;
};
