...
class ArcByCenterStartEndHandler;
class OverlayBase;
class Range;
...
class ArcByCenterStartEndView final: public ToolView, public vn::util::Listener<ArcByCenterStartEndView> {
public:
    ArcByCenterStartEndView(const ArcByCenterStartEndHandler* handler, Repaintable* parent);
    ~ArcByCenterStartEndView() noexcept override;
...
private:
    const ArcByCenterStartEndHandler* handler;
};
