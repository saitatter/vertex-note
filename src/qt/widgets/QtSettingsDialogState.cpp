...
auto QtSettingsDialog::settings() const -> QtSettings {
    ...
    return {
            ...
            .geometryWireframeView = this->geometryWireframeViewCheck->isChecked(),
            .geometryHighlightVertices = this->geometryHighlightVerticesCheck->isChecked(),
            .geometryHighlightLinkedVertices = this->geometryHighlightLinkedVerticesCheck->isChecked(),
            .geometryShowFaceFills = this->geometryShowFaceFillsCheck->isChecked(),
