...
Release:        1%{dist}
Summary:        CAD-inspired note-taking software with PDF annotation support
...
%description
VertexNote is a CAD-inspired technical note-taking application with PDF annotation support.
Supports pen input such as Wacom tablets
...
sed -i -e 's/vertexnote-wrapper/vertex-note/' desktop/app.vertexnote.VertexNote.desktop.in
...
%check
desktop-file-validate %{buildroot}%{_datadir}/applications/app.vertexnote.VertexNote.desktop
appstream-util validate-relax --nonet %{buildroot}%{_metainfodir}/app.vertexnote.VertexNote.appdata.xml
...
%{_bindir}/%{name}
%{_datadir}/applications/app.vertexnote.VertexNote.desktop
%{_datadir}/icons/hicolor/scalable/apps/app.vertexnote.VertexNote.svg
%{_datadir}/icons/hicolor/scalable/mimetypes/*
%{_datadir}/mime/packages/app.vertexnote.VertexNote.xml
%{_datadir}/thumbnailers/app.vertexnote.VertexNote.thumbnailer
%dir %{_datadir}/%{name}
%{_datadir}/%{name}/palettes/{xournal,vertex-note-legacy}.gpl
%{_datadir}/%{name}/resources/{default,legacy}_template.tex
%{_mandir}/man1/%{name}*.gz
%{_metainfodir}/app.vertexnote.VertexNote.appdata.xml
